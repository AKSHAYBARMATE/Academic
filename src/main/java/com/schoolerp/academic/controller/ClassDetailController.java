...
public class ClassDetailController {
  ...
  public ResponseEntity<ApiResponse<ClassDetailResponseDto>> createClassDetail(
      @Valid @RequestBody ClassDetailRequestDto dto) {
    ...
    ApiResponse<ClassDetailResponseDto> response =
        ApiResponse.<ClassDetailResponseDto>builder()
  ...
  public ResponseEntity<ApiResponse<ClassDetailResponseDto>> updateClassDetail(
      @PathVariable Long id, @Valid @RequestBody ClassDetailRequestDto dto) {
  ...
  public ResponseEntity<ApiResponse<Page<ClassDetailResponseDto>>> getAllClassDetails(
    ...
    ApiResponse<Page<ClassDetailResponseDto>> response =
        ApiResponse.<Page<ClassDetailResponseDto>>builder()
            .timestamp(LocalDateTime.now())
            .status(200)
