...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiErrorResponse> handleValidationExceptions(
        ...
        List<ApiErrorResponse.FieldValidationError> fieldErrors = ex.getBindingResult().getFieldErrors()
                .stream()
                .map(err -> new ApiErrorResponse.FieldValidationError(err.getField(), err.getDefaultMessage()))
        ...
        log.error("Validation failed at URI: {} - Errors: {}", request.getRequestURI(), fieldErrors, ex);
    ...
    public ResponseEntity<ApiErrorResponse> handleRuntimeException(RuntimeException ex, HttpServletRequest request) {
        ...
        log.error("RuntimeException at URI: {} - Message: {}", request.getRequestURI(), ex.getMessage(), ex);
    ...
    public ResponseEntity<ApiErrorResponse> handleCustomException(CustomException ex, HttpServletRequest request) {
        ...
        log.error("CustomException at URI: {} - Status: {} - Message: {}", request.getRequestURI(), ex.getStatusCode(), ex.getErrorMessage(), ex);
